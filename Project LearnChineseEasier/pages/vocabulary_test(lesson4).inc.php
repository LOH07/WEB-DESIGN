<script type="text/javascript" src="./js/vocabularyTest(lesson4).js"></script>	
	
	<h1 id="Title">Welcome to Vocabulary Test!</h1> 
	
	<div id="div1">
		<?php include('includes/message_VocabTest.php'); ?>
		<a id="a1" href="http://www.chinesemadeeasier.com" target="_blank">Chinese Made Easier lesson 4</a>
